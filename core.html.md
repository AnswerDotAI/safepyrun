...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L50"
...
`__pytools__` is the set of bare callable names the sandbox allows
(e.g. `'pyrun'`, `'numpy.array'`). `__pytools_cls__` is a
`defaultdict(set)` mapping classes/modules to their allowed method names
(or `...` for all public methods).
[`allow`](https://AnswerDotAI.github.io/safepyrun/core.html#allow)
registers entries — bare strings go into `__pytools__`, dicts go into
`__pytools_cls__`.
...
allow({str: ['zfill']})
assert 'zfill' in __pytools_cls__[str]
allow({list: ...})
assert ... in __pytools_cls__[list]
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L98"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L90"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L83"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L79"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L107"
target="_blank" style="float:right; font-size:smaller">source</a>
...
with `_` (user-exported), is in the allow-set directly, is a key in
`__pytools_cls__`, or its `module.qualname` is registered.
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L180"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L240"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
# @register_cell_magic
# async def py(line, cell): return await pyrun(cell)
```
...
```
    ...
    /var/folders/51/b2_szf2945n072c0vj2cyty40000gn/T/ipykernel_94432/53392176.py:1: UserWarning: a warning
      def f(): warnings.warn('a warning')
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L275"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
try: await pyrun("os.unlink('/foo/bar')")
except AttributeError: print("Correct exception raised")
else: raise Exception("No exception")
```
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/core.py#L386"
target="_blank" style="float:right; font-size:smaller">source</a>
