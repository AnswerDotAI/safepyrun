...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/noaudit.py#L65"
target="_blank" style="float:right; font-size:smaller">source</a>
...
[`_safe_open`](https://AnswerDotAI.github.io/safepyrun/noaudit.html#_safe_open)
...
<a
href="https://github.com/AnswerDotAI/safepyrun/blob/main/safepyrun/noaudit.py#L110"
target="_blank" style="float:right; font-size:smaller">source</a>
...
[`_make_safe_getattr`](https://AnswerDotAI.github.io/safepyrun/noaudit.html#_make_safe_getattr)
...
```
    ...
    /var/folders/51/b2_szf2945n072c0vj2cyty40000gn/T/ipykernel_93506/2295904293.py:2: UserWarning: a warning
      def f(): warnings.warn('a warning')
...
```
    ...
    Traceback (most recent call last):
      File "/var/folders/51/b2_szf2945n072c0vj2cyty40000gn/T/ipykernel_93506/3414206815.py", line 1, in <module>
        try: await pyrun('os.system("ls")')
             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "/var/folders/51/b2_szf2945n072c0vj2cyty40000gn/T/ipykernel_93506/3714113416.py", line 39, in __call__
        raise e.with_traceback(tb) from None
      File "<pyrun_5>", line 1, in <module>
        os.system('ls')
      File "/var/folders/51/b2_szf2945n072c0vj2cyty40000gn/T/ipykernel_93506/1745616310.py", line 16, in __call__
...
[`_default_write_`](https://AnswerDotAI.github.io/safepyrun/noaudit.html#_default_write_)
is the guard injected into the sandbox as `_write_` — it’s called by
[`SafeTransformer`](https://AnswerDotAI.github.io/safepyrun/noaudit.html#safetransformer)-compiled
code whenever an attribute store or item assignment occurs. It returns a
[`_WriteGuard`](https://AnswerDotAI.github.io/safepyrun/noaudit.html#_writeguard)
proxy that:
...
![](03_noaudit_files/figure-commonmark/cell-82-output-1.png)
...
![](03_noaudit_files/figure-commonmark/cell-83-output-1.png)
